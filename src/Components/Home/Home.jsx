...
const Home = () => {
    return (
        <div>
            ...
            <header className="flex flex-col lg:flex-row items-center justify-between  p-5 lg:px-48 gap-10 bg-[#f8f9fd]">
                <div className="lg:w-1/2 space-y-6">
                    ...
                    <div className="flex space-x-4">
                        <button className="inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-[#3D238C] h-10 px-4 py-2 bg-[#2E1D66] text-white">
                            View More
                        </button>
            ...
            <div className="fixed overflow-hidden bottom-5 right-5 z-50">
